...
//             money. The user should enter the amount desied and the machine 
//             dispenses this amount using the learn number of bills.
//
// Date: 11-13-2010
//*******************************************************************************
...
int main(void)
{
      ...
      while(ans=='Y'||ans=='y')
        {
                /* Enter the amount desired . if the amount is incorrect
